...
function pillars(profile: BirthProfile) {
  return Object.entries(profile.chart.pillars)
    .map(([key, value], index) => {
      ...
      return `
        <rect x="${x}" y="520" width="112" height="136" rx="8" fill="#11191e" stroke="#3b3934"/>
...
function coverCard(profile: BirthProfile) {
  ...
  return `
    <rect width="720" height="960" fill="#05090d"/>
    <rect x="40" y="40" width="640" height="880" rx="8" fill="#0d1318" stroke="#3b3934"/>
    <rect x="40" y="40" width="640" height="260" rx="8" fill="#09151b"/>
    <text x="82" y="112" class="eyebrow">玄枢 · 报告封面</text>
    ...
    <rect x="82" y="752" width="556" height="96" rx="8" fill="#11191e" stroke="#2b3033"/>
...
function wuxingCard(profile: BirthProfile) {
  ...
  const bars = entries
    .map(([key, value], index) => {
      ...
      return `
        ...
        <rect x="150" y="${y - 10}" width="430" height="26" rx="13" fill="#172126"/>
  ...
  return `
    ...
    <rect x="82" y="258" width="556" height="500" rx="8" fill="#11191e" stroke="#2b3033"/>
    ${bars}
    <text x="82" y="820" class="body">${escapeXml(`适合围绕${profile.chart.dayMaster.elementLabel}的节奏，先把现实中的下一步做清楚。`)}</text>
    <text x="82" y="884" class="tiny">玄枢 · 免费文化参考</text>
  `;
}
...
function dailyCard(profile: BirthProfile) {
  ...
  return `
    ...
    <rect x="40" y="40" width="640" height="880" rx="8" fill="#0d1318" stroke="#3b3934"/>
    <rect x="40" y="40" width="640" height="260" rx="8" fill="#09151b"/>
    <text x="82" y="112" class="eyebrow">玄枢 · 今日方向</text>
    ...
    <rect x="82" y="472" width="254" height="176" rx="8" fill="#11191e" stroke="#2b3033"/>
    <text x="112" y="520" class="section">适合做</text>
    ${listItems(guidance.suitable, 112, 566, "#2d6b6f")}

    <rect x="384" y="472" width="254" height="176" rx="8" fill="#11191e" stroke="#2b3033"/>
    <text x="414" y="520" class="section">暂缓做</text>
    ${listItems(guidance.avoid, 414, 566, "#a5533c")}

    <rect x="82" y="692" width="556" height="142" rx="8" fill="#172126" stroke="#3b3934"/>
...
<svg xmlns="http://www.w3.org/2000/svg" width="720" height="960" viewBox="0 0 720 960">
  <style>
    .eyebrow { fill: #d1ad73; font: 500 22px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .eyebrowDark { fill: #bd4c3e; font: 500 22px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .title { fill: #ffffff; font: 700 52px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .titleDark { fill: #e9e3d8; font: 700 52px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .element { fill: #ffffff; font: 700 30px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .subtitle { fill: #c9d1cd; font: 400 24px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .subtitleDark { fill: #9b968d; font: 400 24px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .section { fill: #e9e3d8; font: 700 24px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .body { fill: #b7b1a7; font: 400 24px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .caption { fill: #8e8980; font: 400 18px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .pillar { fill: #d1ad73; font: 700 34px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
    .tiny { fill: #8e8980; font: 400 18px "Microsoft YaHei", "PingFang SC", Arial, sans-serif; }
  </style>
  ${body}
</svg>`;
}
